...
public class MumbleLink extends Thread {
    ...
    private final long REFRESH_RATE = 25;
    ...
    // Constructor
    public MumbleLink() {
	sharedFile = Kernel32.INSTANCE.CreateFileMapping(WinBase.INVALID_HANDLE_VALUE, null,
		WinNT.PAGE_EXECUTE_READWRITE, 0, MEM_MAP_SIZE, MEM_MAP_NAME);
	sharedMemory = Kernel32.INSTANCE.MapViewOfFile(sharedFile, WinNT.SECTION_MAP_READ, 0, 0, MEM_MAP_SIZE);
	...
	try {
		...
		// System.out.println("fAvatarFront: " +
		// Arrays.toString(fAvatarFront));
		// System.out.println("fAvatarTop: " +
		// Arrays.toString(fAvatarTop));
		// System.out.println("gameName: " + (new
		// String(gameName)).trim());
		// System.out.println("fCameraPosition: " +
		// Arrays.toString(fCameraPosition));
		// System.out.println("fCameraFront: " +
		// Arrays.toString(fCameraFront));
		// System.out.println("fCameraTop: " +
		// Arrays.toString(fCameraTop));
		// System.out.println("identity: " + (new
    ...
    /**
     * Retrieved JSON may sometimes be untrimmed, extracts only the outermost {}
     * part.
     *
