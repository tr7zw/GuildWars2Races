...
import de.tr7zw.gw2racing.region.Polygon;
...
public class APIHelper {
    ...
    public APIHelper(Gw2Racing main) {
	this.main = main;
    }
	...
	File mapDir = new File(main.getDataDir(), "maps");
	if (!mapDir.exists()) {
	    mapDir.mkdir();
	}
	...
	try {
	    HttpURLConnection connection = (HttpURLConnection) new URL("https://api.guildwars2.com/v2" + path)
		    .openConnection();
