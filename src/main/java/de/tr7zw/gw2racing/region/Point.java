...
public class Point {
	...
	return new Point(
		continentRect[0].x + (continentRect[1].x - continentRect[0].x) * (coords.x - mapRect[0].x)
			/ (mapRect[1].x - mapRect[0].x),
		continentRect[0].y + (continentRect[1].y - continentRect[0].y)
			* (1 - (coords.y - mapRect[0].y) / (mapRect[1].y - mapRect[0].y)));
    }
